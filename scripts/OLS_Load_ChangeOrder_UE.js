...
var CLIENT_SCRIPT_FILE_PATH = "SuiteScripts/OLS_Load_ChangeOrder_CL.js";
    ...
    function beforeLoad(scriptContext) {
        if(scriptContext.type == 'view') {
            ...
            projectForm.addButton({
                id : 'custpage_ols_load_co_btn',
                label : 'Load Change Order',
                functionName : 'loadChangeOrder(' + recId + ')'
            });
        }
    }
    return {
